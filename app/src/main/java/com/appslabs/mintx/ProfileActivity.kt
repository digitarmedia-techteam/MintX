...
import com.appslabs.mintx.databinding.ActivityProfileViewBinding
...
class ProfileActivity : AppCompatActivity() {
        ...
        db.collection("users").document(uid).get()
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    val user = document.toObject(com.appslabs.mintx.data.model.User::class.java)
                    user?.let {
                        ...
                        val levelInfo = com.appslabs.mintx.utils.LevelUtils.calculateLevelInfo(it.totalXP)
    ...
    private fun navigateToLogin() {
        val intent = Intent(this, com.appslabs.mintx.auth.AuthActivity::class.java)
