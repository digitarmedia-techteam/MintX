...
import com.appslabs.mintx.databinding.ActivityQuizBinding
import com.appslabs.mintx.ui.quiz.QuizCategoryBottomSheet
import com.appslabs.mintx.ui.quiz.QuizViewModel
import com.appslabs.mintx.utils.AdManager.showRewardedAd
import com.appslabs.mintx.utils.LevelUtils
...
class QuizActivity : AppCompatActivity() {
    ...
    private val viewModel: QuizViewModel by viewModels {
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                val questionTracker = com.appslabs.mintx.utils.QuestionTracker(this@QuizActivity)
                return QuizViewModel(QuizRepository(this@QuizActivity), questionTracker) as T
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.root.postDelayed({
            com.appslabs.mintx.utils.AdManager.loadRewardedAd(this)
            com.appslabs.mintx.utils.AdManager.loadInterstitialAd(this)
        }, 1000)
    }
        ...
        viewModel.questions.observe(this) { questions ->
            if (questions.isNotEmpty()) {
                if (binding.layoutSkeleton.root.visibility == View.VISIBLE && binding.layoutSkeleton.root.alpha > 0f) {
                    ...
                    com.appslabs.mintx.utils.AdManager.showInterstitialAd(this) {
    ...
    private fun highlightSelection(view: View, selectedKey: String, question: QuizQuestion) {
        ...
        if (isCorrect) {
            ...
            if (uid != null) {
                ...
                val todayKey = com.appslabs.mintx.utils.StreakUtils.getTodayDateKey()
    ...
    private fun setupBottomNavigation() {
        val bottomBar = binding.bottomNavigation.root as com.appslabs.mintx.ui.components.SmoothBottomBar
