...
import com.appslabs.mintx.databinding.BottomSheetQuizCategoriesBinding
    ...
    private val viewModel: QuizViewModel by viewModels {
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                val questionTracker = com.appslabs.mintx.utils.QuestionTracker(requireContext())
                return QuizViewModel(QuizRepository(requireContext()), questionTracker) as T
            }
        }
    }
